...
<<<<<<< HEAD
                                <a href="{{ route('customers.index') }}" class="btn btn-danger btn-lg mt-3" style="border-color: #0e0e0e; background-color: #b51200b6;">><i
=======
                                <a href="{{ route('customers.index') }}" class="btn btn-danger btn-lg mt-3" style="border-color: #0e0e0e; background-color: #b53600b6;"><i
>>>>>>> fef537290bc4aa28da2e5786cc0c1874e12c0528
        ...
        <div class="row justify-content-between mt-5">
            <div class="col-md-3">
                <div class="card" style="background-color: #000000be;">
                    ...
                    <div class="card-body">
                        <ul>
                            <li style="color: #FFFFFF;">Engine: 1.5L DOHC 4-Cylinder Turbo, producing 178 PS (approximately 175 HP) at 6,000 rpm and 240 Nm torque at 1,700–4,500 rpm.</li>
            ...
            <div class="col-md-3">
                <div class="card" style="background-color: #000000be;">
                    ...
                    <div class="card-body">
                        <ul>
                            <li style="color: #FFFFFF;">Engine: 1.5L VTEC Turbo, producing 177 PS (approximately 175 HP) at 6,000 rpm and a maximum torque of 240 Nm at 1,700–4,500 rpm.</li>
                            <li style="color: #FFFFFF;">Transmission: CVT</li>
                            <li style="color: #FFFFFF;">Passenger Capacity: 5 persons</li>
                        </ul>
                    </div>
            ...
            <div class="col-md-3">
                <div class="card" style="background-color: #000000be;">
                    ...
                    <div class="card-body">
                        <ul>
                            <li style="color: #FFFFFF;">Engine: 1.5L 2NR-VE DOHC Dual VVT-i, producing  103 HP at 6,000 rpm and a maximum torque of 13.9 kg.m at 4,200 rpm.</li>
            ...
            <div class="col-md-3">
                <div class="card" style="background-color: #000000be;">
                    ...
                    <div class="card-body">
                        <ul>
                            <li style="color: #FFFFFF;">Engine: 2.0L M20A-FKS Dynamic Force Engine, 4-cylinder, Dual VVT-i, producing 174 PS at 6,600 rpm and 20.9 kg·m of torque at 4,500–4,900 rpm.</li>
        ...
        <div class="row justify-content-between mt-5">
            <div class="col-md-3">
                <div class="card" style="background-color: #000000be;">
                    ...
                    <div class="card-body">
                        <ul>
                            <li style="color: #FFFFFF;">1.2L SOHC 4-cylinder in-line, 16 valves i-VTEC + DBW, with a displacement of 1,198 cc.</li>
            ...
            <div class="col-md-3">
                <div class="card" style="background-color: #000000be;">
                    ...
                    <div class="card-body">
                        <ul>
                            <li style="color: #FFFFFF;">Engine: 1.5L 4-cylinder in-line, DOHC, dengan displacement 1,462 cc.</li>
                ...
                <div class="card" style="background-color: #000000be;">
                    ...
                    <div class="card-body">
                        <ul>
                            ...
                            <li style="color: #FFFFFF;">Transmission:  CVT (Continuously Variable Transmission) automatic.</li>
                            <li style="color: #FFFFFF;">Passenger Capacity: 5 persons</li>
                        </ul>
                    </div>
                </div>
